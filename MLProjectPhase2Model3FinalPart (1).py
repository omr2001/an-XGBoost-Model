...
#              predictor='auto', random_state=0, reg_alpha=0,reg_lambda=1,scale_pos_weight=1,subsample=1,tree_method='exact',
...
print("Training_Score : {}".format(classifier.score(X_train,Y_train)))
...
print('The Testing Accuracy is ',accuracy_score(Y_test,Y_Prediction))
...
## Saving Model
import pickle
file=open(r'D:\ML Project\modelXGBoost.pkl','wb')
pickle.dump(classifier,file)
file.close()
forest=pickle.load(open('D:\ML Project\modelXGBoost.pkl','rb'))
